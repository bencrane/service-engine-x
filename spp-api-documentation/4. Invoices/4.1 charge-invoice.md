...
Charges an invoice using a payment method ID. If the invoice has a custom billing date, it will be removed.
...
Example: `pm_1J5gXt2eZvKYlo2C3X2Z2Z2Z`
...
```curl
curl --request POST \
  --url https://example.spp.co/api/invoices/{invoice}/charge \
