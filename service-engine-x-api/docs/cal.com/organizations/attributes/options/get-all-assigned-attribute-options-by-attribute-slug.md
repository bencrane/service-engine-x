...
`GET /v2/organizations/{orgId}/attributes/slugs/{attributeSlug}/options/assigned`
...
```bash
curl -X GET \
  "https://api.cal.com/v2/organizations/<orgId>/attributes/slugs/<attributeSlug>/options/assigned" \
