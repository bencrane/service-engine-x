...
# Replace all permissions for an organization role - Cal.com Docs

Permissions
# Replace all permissions for an organization role
Copy page

Required membership role: `org admin`. PBAC permission: `role.update`. Learn more about API access control at https://cal.com/docs/api-reference/v2/access-controlCopy pagePUT/v2/organizations/{orgId}/roles/{roleId}/permissionsTry itReplace all permissions for an organization role
