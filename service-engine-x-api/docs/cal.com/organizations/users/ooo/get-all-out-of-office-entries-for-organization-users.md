...
# Get all out-of-office entries for organization users - Cal.com Docs

OOO
# Get all out-of-office entries for organization users
Copy pageCopy pageGET/v2/organizations/{orgId}/oooTry itGet all out-of-office entries for organization users
...
`"?sortEnd=asc OR ?sortEnd=desc"`​emailstring

Filter ooo entries by the user email address. user must be within your organization.Example:
