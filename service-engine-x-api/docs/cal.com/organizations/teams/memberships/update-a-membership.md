...
- **`role`** (`"MEMBER"` | `"OWNER"` | `"ADMIN"`) *optional*
...
```bash
curl -X PATCH "https://api.cal.com/v2/organizations/{orgId}/teams/{teamId}/memberships/{membershipId}" \
  -H "Authorization: Bearer <token>" \
  -H "cal-api-version: 2024-08-13" \
  -H "Content-Type: application/json" \
  -d '{"accepted": true, "role": "MEMBER", "disableImpersonation": true}'
```
