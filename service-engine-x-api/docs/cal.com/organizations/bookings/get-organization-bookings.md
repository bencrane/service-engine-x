...
# Get organization bookings - Cal.com Docs

Bookings
# Get organization bookings
Copy page

Required membership role: `org admin`. PBAC permission: `booking.readOrgBookings`. Learn more about API access control at https://cal.com/docs/api-reference/v2/access-controlCopy pageGET/v2/organizations/{orgId}/bookingsTry itGet organization bookings

cURL
```
`curl --request GET \
  --url https://api.cal.com/v2/organizations/{orgId}/bookings`
```
200
```
`{
...
Filter bookings by ids of users within your organization.Example:
