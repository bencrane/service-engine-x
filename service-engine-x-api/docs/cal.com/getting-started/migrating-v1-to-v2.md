...
# Migrating from API v1 to v2 - Cal.com Docs

Getting Started
# Migrating from API v1 to v2
Copy page

Complete guide for migrating your Cal.com integration from v1 to v2Copy page**API v1 is deprecated and will be permanently shut down on April 8, 2026.** Please migrate to API v2 as soon as possible.
