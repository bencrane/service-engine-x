...
# AI agents - Cal.com Docs

Getting Started
# AI agents
Copy page

How AI agents can use the Cal.com API v2 to manage schedulingCopy pageThis guide explains how to build AI agents that interact with Cal.com’s scheduling infrastructure.
...
ParameterRequiredDescription`credits`YesNumber of credits to charge (minimum 1)`creditFor`YesUsage type — use `AI_AGENT` for agent interactions`externalRef`NoUnique reference string for idempotency. Prevents double-charging if the same request is retried.
