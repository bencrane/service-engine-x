...
Platform / Webhooks
# Get a webhook
Copy pageThese endpoints are deprecated and will be removed in the future.Copy pageGET/v2/oauth-clients/{clientId}/webhooks/{webhookId}Try itGet a webhook
