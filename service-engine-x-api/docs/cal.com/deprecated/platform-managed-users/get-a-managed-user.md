...
# Get a managed user - Cal.com Docs

Platform / Managed Users
# Get a managed user
Copy pageThese endpoints are deprecated and will be removed in the future.Copy pageGET/v2/oauth-clients/{clientId}/users/{userId}Try itGet a managed user
