...
# Create an out-of-office entry for the authenticated user - Cal.com Docs

Out of Office
# Create an out-of-office entry for the authenticated user
Copy pageCopy pagePOST/v2/me/oooTry itCreate an out-of-office entry for the authenticated user
