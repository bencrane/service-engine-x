...
@router.put("/orgs/{org_id}/meetings/{meeting_id}", dependencies=[Depends(verify_internal_key)])
...
@router.post("/orgs/{org_id}/deals", dependencies=[Depends(verify_internal_key)])
...
@router.get("/orgs/{org_id}/deals/{deal_id}", dependencies=[Depends(verify_internal_key)])
...
@router.put("/orgs/{org_id}/deals/{deal_id}", dependencies=[Depends(verify_internal_key)])
