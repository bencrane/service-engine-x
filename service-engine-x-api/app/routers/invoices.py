...
def serialize_invoice_item(item: dict[str, Any]) -> InvoiceItemResponse:
    ...
    return InvoiceItemResponse(
        ...
        discount2=str(item.get("discount2", "0.00")) if item.get("discount2") else None,
...
def serialize_invoice_client(client: dict[str, Any]) -> InvoiceClientResponse:
    ...
    return InvoiceClientResponse(
        ...
        balance=str(client.get("balance")) if client.get("balance") else None,
...
def serialize_invoice(invoice: dict[str, Any]) -> InvoiceResponse:
    ...
    return InvoiceResponse(
        ...
        credit=str(invoice.get("credit", "0.00")) if invoice.get("credit") is not None else None,
        tax=str(invoice.get("tax", "0.00")) if invoice.get("tax") is not None else None,
        tax_name=invoice.get("tax_name"),
        tax_percent=str(invoice.get("tax_percent", "0")) if invoice.get("tax_percent") is not None else None,
        ...
        subtotal=str(invoice.get("subtotal", "0.00")),
        total=str(invoice.get("total", "0.00")),
