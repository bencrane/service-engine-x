...
@router.get("/orgs/{org_id}/accounts", dependencies=[Depends(verify_internal_key)])
...
@router.get("/orgs/{org_id}/accounts/{account_id}", dependencies=[Depends(verify_internal_key)])
...
@router.get("/orgs/{org_id}/contacts", dependencies=[Depends(verify_internal_key)])
...
@router.get("/orgs/{org_id}/contacts/{contact_id}", dependencies=[Depends(verify_internal_key)])
...
@router.get("/orgs/{org_id}/proposals", dependencies=[Depends(verify_internal_key)])
...
@router.get("/orgs/{org_id}/proposals/{proposal_id}", dependencies=[Depends(verify_internal_key)])
...
@router.get("/orgs/{org_id}/proposals/{proposal_id}/deliverables", dependencies=[Depends(verify_internal_key)])
...
@router.get("/orgs/{org_id}/engagements", dependencies=[Depends(verify_internal_key)])
...
@router.get("/orgs/{org_id}/engagements/{engagement_id}", dependencies=[Depends(verify_internal_key)])
...
@router.get("/orgs/{org_id}/projects", dependencies=[Depends(verify_internal_key)])
...
@router.get("/orgs/{org_id}/projects/{project_id}", dependencies=[Depends(verify_internal_key)])
...
@router.get("/orgs/{org_id}/orders", dependencies=[Depends(verify_internal_key)])
...
@router.get("/orgs/{org_id}/orders/{order_id}", dependencies=[Depends(verify_internal_key)])
