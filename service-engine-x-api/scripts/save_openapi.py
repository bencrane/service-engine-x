...
os.environ.setdefault("SERVICE_ENGINE_X_SUPABASE_URL", "https://placeholder.supabase.co")
os.environ.setdefault("SERVICE_ENGINE_X_SUPABASE_SERVICE_ROLE_KEY", "placeholder")
